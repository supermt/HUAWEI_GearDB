...
/*
 * optimize the options for heterogeneous storage, but it's not important now
 *
Options* Options::OptimizeForHeterogeneousDB() {
  if (path_type_list.size()) {
    return this;
  }
...
ColumnFamilyOptions* ColumnFamilyOptions::OptimizeForHetergenousDB(
    std::shared_ptr<Cache>* cache) {}

DBOptions* DBOptions::OptimizeForHetergenousDB(std::shared_ptr<Cache>* cache) {}
